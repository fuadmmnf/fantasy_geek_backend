...
class RunningFixtureTrackerScheduler
{
    ...
    private function checkRunningFixtureAndUpdateContestScores()
    {
        ...
        $runningFixtures->load('pointdistribution', 'scorecards', 'scorecards.player', 'contests',  'contests.usercontests', 'contests.usercontests.team', 'contests.usercontests.user');
